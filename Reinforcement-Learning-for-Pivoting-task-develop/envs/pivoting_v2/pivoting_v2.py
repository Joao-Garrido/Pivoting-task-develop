...
class PivotingEnv(gym.Env):
    ...
    def reset(self, *, seed=None, options=None):
        # 1. Chamar o reset da classe pai para lidar com a seed (MUITO IMPORTANTE)
        super().reset(seed=seed)

        # 2. O resto do seu código original continua igual
        self.mj.reset_sim()
        ...
        info = {}  # O Gymnasium espera que o reset retorne (obs, info)
